...
def attack(char_name: str, char_class: str) -> str:
    """Вызывает функцию attack различных классов и.
    имен,показывает наносимый ими урон, и возвращает класс и имя.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Вызывает функцию защиты различных классов и.
    имен,показывает блокируемый ими урон, и возвращает класс и имя.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Вызывает функцию специального умения различных классов и.
    имен,показывает что за умение и наносимый урон или блок, и.
    возвращает класс и имя.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Вызывает функцию тренировки различных классов и.
    имен,а также различные умения, и возвращает класс и имя.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Вызывает функцию выбора различных классов, и возвращает класс."""
    approve_choice: str = ''
    char_class: str = ''
